      ...
      <div className="flex flex-col items-center gap-8 w-full max-w-sm px-6">
        ...
        <div className="w-full rounded-xl border border-border bg-card p-6 shadow-sm">
          ...
          >
            <button
              type="submit"
              className="w-full flex items-center justify-center gap-3 px-4 py-2.5 rounded-lg border border-border bg-background text-sm font-medium hover:bg-accent transition-colors"
            >
              {/* Google logo */}
        ...
        <p className="text-xs text-muted-foreground text-center">
          Use the same Google account connected to your Chrome extension.
        </p>
      </div>
    </div>
  );
